...
if text == "ماشین حساب":
    print ("ok! what do you want to do with calculater?")
        
    calculater = gTTS("ok! what do you want to do with calculater?")
    calculater.save("calculater.mp3")

    playsound("calculater.mp3")
    ...
    with sr.Microphone() as source:        
        ...
        try:
            ...
            recognizing_voice11 = gTTS("let me recognize!")
            recognizing_voice11.save("recognizing11_voice.mp3")
        
            playsound("recognizing11_voice.mp3")
            ...
            recognizing_voice10 = gTTS("I can not recognize your voice!")
            recognizing_voice10.save("recognizing10_voice.mp3")

            playsound("recognizing10_voice.mp3")
            ...
            if query == "جمع":
                ...
                print ("ok! please enter the first number")
        
                add1 = gTTS("ok! please enter the first number")
                add1.save("add1.mp3")
                ...
                with sr.Microphone() as source:        
                    ...
                    try:
                        ...
                        query_add1 = r.recognize_google(audio, language= 'fa-IR', show_all=False)
                        print(query)
                ...
                print ("ok! please enter the second number")
        
                add2 = gTTS("ok! please enter the second number")
                add2.save("add2.mp3")
                ...
                with sr.Microphone() as source:        
                    ...
                    try:
                        ...
                        query_add2 = r.recognize_google(audio, language= 'fa-IR', show_all=False)
                        print(query)
                        ...
                        query_add1_int = int(query_add1)
                        query_add2_int = int(query_add2)
                        
                        print (query_add1_int + query_add2_int)
